...
def main(args):
    ...
    if "ssdca" in args.model_config.lower() or "ssfc" in args.model_config.lower():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", required=True, help="Path to root dataset directory containing images and JSON files")
    parser.add_argument("--pretrained_weights", default="", help="Path to pretrained checkpoint for linear probe mode")
